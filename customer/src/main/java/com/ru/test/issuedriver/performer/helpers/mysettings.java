...
//    }
    ...
    public static void SetEmail(String phone) {
        ...
        editor.putString(com.ru.test.issuedriver.helpers.mysettings.APP_PREFERENCES_EMAIL, phone);
        editor.apply();
    }

    public static void SetPass(String pass) {
        SharedPreferences.Editor editor = instance.edit();
        editor.putString(com.ru.test.issuedriver.helpers.mysettings.APP_PREFERENCES_PASS, pass);
        editor.apply();
    }

    public static void SetPosition(String pos) {
        SharedPreferences.Editor editor = instance.edit();
        editor.putString(com.ru.test.issuedriver.helpers.mysettings.APP_PREFERENCES_POSITION, pos);
        editor.apply();
    }
    public static void SetOrders(String orders) {
        SharedPreferences.Editor editor = instance.edit();
        editor.putString(com.ru.test.issuedriver.helpers.mysettings.APP_PREFERENCES_ORDERS, orders);
        editor.apply();
    }
...
//        SharedPreferences.Editor editor = instance.edit();
//        editor.putString(com.ru.test.issuedriver.helpers.mysettings.APP_PREFERENCES_ACTIVITY, activity);
//        editor.apply();
//    }
}
