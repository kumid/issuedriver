...
//            geoQuery.removeAllListeners();
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                if(geofireCallBacks.callback4geofireItemRecieve != null)
                    geofireCallBacks.callback4geofireItemRecieve.callback(key, location);
                System.out.println(String.format("Key %s entered the search area at [%f,%f]", key, location.latitude, location.longitude));
            }

            @Override
            public void onKeyExited(String key) {
                if(geofireCallBacks.callback4geofireItemExitRecieve != null)
                    geofireCallBacks.callback4geofireItemExitRecieve.callback(key);
