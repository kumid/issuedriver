package com.ru.test.issuedriver.taxi.performer.helpers;
...
//    }
    ...
    public static void SetEmail(String phone) {
        ...
        editor.putString(APP_PREFERENCES_EMAIL, phone);
        editor.apply();
    }
    ...
    public static void SetPosition(String pos) {
        SharedPreferences.Editor editor = instance.edit();
        editor.putString(APP_PREFERENCES_POSITION, pos);
        editor.apply();
    }
    public static void SetOrders(String orders) {
        SharedPreferences.Editor editor = instance.edit();
        editor.putString(APP_PREFERENCES_ORDERS, orders);
        editor.apply();
    }
